...
export default function GithubBager() {
    ...
    return (
        <Link href="https://github.com/Attato/Knotter" target="_blank" className="flex items-center">
            <div className="w-9 h-[30px] flex items-center justify-center bg-[#0f0f0f] border border-[#1a1a1a] rounded-l-md">
                <svg
                    height="20"
                    width="20"
                    aria-hidden="true"
            ...
            <div className="h-[30px] flex items-center justify-center bg-[#0f0f0f] border border-l-0 border-[#1a1a1a] rounded-r-md">
